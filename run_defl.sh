...
tmux new -d -s client-0 "./fl_client.py 127.0.0.1:9004 --train 500 --gst 2000 --timeout 1000 2> logs/client-0.log"
tmux new -d -s client-1 "./fl_client.py 127.0.0.1:9005 --train 500 --gst 2000 --timeout 1000 2> logs/client-1.log"
tmux new -d -s client-2 "./fl_client.py 127.0.0.1:9006 --train 500 --gst 2000 --timeout 1000 2> logs/client-2.log"
tmux new -d -s client-3 "./fl_client.py 127.0.0.1:9007 --train 500 --gst 2000 --timeout 1000 2> logs/client-3.log"
